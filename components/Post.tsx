...
const Post = ({ post }: PostProps) => {
  return (
    <div className="bg-white flex flex-col rounded-xl border bottom-1 border-gray-200 shadow-sm mt-5">
      <div className="p-4">
      ...
      <div className="bg-white flex justify-between items-centertext-gray-400 rounded-b-xl border-t">
